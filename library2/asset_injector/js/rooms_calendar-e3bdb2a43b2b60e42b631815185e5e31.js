...
function getRoom(room) {
  ...
  {
	case '3787':
	  var room_name = 'Room 207';
	  break;
	case '3788':
	  var room_name = 'Room 408';
	  break;
	case '3789':
	  var room_name = 'Room 409';
	  break;
	case '3790':
	  var room_name = 'Room 471';
	  break;
	case '3792':
	  var room_name = 'Room 508';
	  break;
	case '3793':
	  var room_name = 'Room 509';
	  break;
	case '3794':
	  var room_name = 'Room 522';
	  break;
	case '3796':
	  var room_name = 'Room 531';
	  break;
	case '3797':
	  var room_name = 'Room 605';
	  break;
	case '3798':
	  var room_name = 'Room 613';
	  break;
	case '3799':
	  var room_name = 'Room 614';
	  break;
	case '3800':
	  var room_name = 'Room 615';
	  break;
	case '3801':
	  var room_name = 'Room 621';
	  break;
  }
  return room_name;
}
...
<br><span class='time'>" + timeStart.format('h:mm A') + "<br>-<br>" + timeEnd + "</span>";
...
var layOutDay = (events) =>
{
  ...
  events.forEach((event, id) =>
  {
	...
	let height = (event.end - event.start) / minutesinDay * 720;
	let top = event.start / minutesinDay * 720;
	let end = event.end;
...
async function loadNames()
{
  ...
  var base_urla = '/slr/calendar?date=';
  var base_urlb = '/slr/calendar';
  var base_urlc = '/slr/request?date=';
  var js_base = '/slr_day.json';
...
console.log(room_events);
  ...
  var calendar_url = '/slr/calendar?date=';
